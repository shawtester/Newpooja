...
export default function Page() {
  ...
  const [imageList, setImageList] = useState([]); // Removed featureImage state
  ...
  const handleCreate = async () => {
    ...
    try {
      await createNewProduct({
        data: data,
        imageList: imageList, // Pass image list here
      });
      setData(null);
      setImageList([]); // Clear image list after creation
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      setData(null);
      setImageList([]); // Clear image list after update
      ...
      <div className="flex flex-col md:flex-row gap-5">
        ...
        <div className="flex-1 flex flex-col gap-5 h-full">
          <Images
            data={data}
            imageList={imageList} // Pass image list here
            setImageList={setImageList} // Pass setImageList to Images component
          />
